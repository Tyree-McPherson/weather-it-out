...
describe("Test Functions", () => {
  ...
  test("Convert date to time", () => {
    ...
    const date = convertDateToTime(new Date("Thu Nov 10 2022 16:48:30 GMT-0500 (Eastern Standard Time)"))
    const time = "4:48 PM"
  ...
  test("Convert text to icon", () => {
    ...
    expect(convertTextToIcon("Thunderstorm", time)).toEqual("mdi-weather-lightning")
  ...
  test("Get day of week", () => {
    ...
    const date1 = new Date("Sun Nov 6 2022 14:48:30 GMT-0500 (Eastern Standard Time)")
    const date2 = new Date("Mon Nov 7 2022 14:48:30 GMT-0500 (Eastern Standard Time)")
    const date3 = new Date("Tue Nov 8 2022 14:48:30 GMT-0500 (Eastern Standard Time)")
    const date4 = new Date("Wed Nov 9 2022 14:48:30 GMT-0500 (Eastern Standard Time)")
    const date5 = new Date("Thu Nov 10 2022 14:48:30 GMT-0500 (Eastern Standard Time)")
    const date6 = new Date("Fri Nov 11 2022 14:48:30 GMT-0500 (Eastern Standard Time)")
    const date7 = new Date("Sat Nov 12 2022 14:48:30 GMT-0500 (Eastern Standard Time)")
